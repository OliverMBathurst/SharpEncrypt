...
namespace SharpEncrypt.ExtensionClasses
{
    ...
    {
        public static FolderModel GetSubFolder(this FolderModel masterModel, Func<FolderModel, bool> predicate)
        {
        ...
        public static FileModel GetFileModel(this FolderModel folderModel, Func<FileModel, bool> predicate)
        {
        ...
        public static IEnumerable<FileModel> GetFileModels(this FolderModel folderModel, Func<FileModel, bool> predicate)
